  ...
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form id="settingsForm" action="#" method="post">
          <div class="d-flex py-2">
            <label class="offset-1 col-5 text-center" for="mainFontColor">Couleur principale de la police :</label>
            <div class="col-6 d-flex">
              <input id="mainFontColor" class="mx-auto" type="color" name="mainFontColor" value="#000000">
            </div>
          </div>
          <div class="d-flex py-2">
            <label class="offset-1 col-5 text-center" for="secondaryFontColor">Couleur secondaire de la police :</label>
            <div class="col-6 d-flex">
              <input id="secondaryFontColor" class="mx-auto" type="color" name="secondaryFontColor" value="#FFFFFF">
            </div>
          </div>
          <div class="d-flex py-2">
            <label class="offset-1 col-5 text-center" for="mainBackgroundColor">Couleur de fond principale :</label>
            <div class="col-6 d-flex">
              <input id="mainBackgroundColor" class="mx-auto" type="color" name="mainBackgroundColor" value="#E8DCD8">
            </div>
          </div>
          <div class="d-flex py-2">
            <label class="offset-1 col-5 text-center" for="secondaryBackgroundColor">Couleur de fond secondaire :</label>
            <div class="col-6 d-flex">
              <input id="secondaryBackgroundColor" class="mx-auto" type="color" name="secondaryBackgroundColor" value="#C1C1C1">
            </div>
          </div>
          <div class="d-flex py-2">
            <label class="offset-1 col-5 text-center" for="headerBackgroundColor">Couleur de l'entête :</label>
            <div class="col-6 d-flex">
              <input id="headerBackgroundColor" class="mx-auto" type="color" name="headerBackgroundColor" value="#463730">
            </div>
          </div>
          <div class="d-flex py-2">
            <label class="offset-1 col-5 text-center" for="statsBackgroundColor">Couleur des statistiques :</label>
            <div class="col-6 d-flex">
              <input id="statsBackgroundColor" class="mx-auto" type="color" name="statsBackgroundColor" value="#BF6B44">
            </div>
          </div>
          <div class="form-check d-flex px-0 py-2">
            <label class="form-check-label offset-1 col-5 text-center" for="displayTimer">Afficher le chronomètre lors de la résolution</label>
          ...
          <div class="d-flex py-2">
            <label class="offset-1 col-5 text-center" for="mainFont">Police principale :</label>
            <div class="col-6 d-flex">
          ...
          <div class="d-flex py-2">
            <label class="offset-1 col-5 text-center" for="timerFont">Police du chronomètre :</label>
            <div class="col-6 d-flex">
      ...
      <div class="modal-footer bg-dark">
        ...
        <button type="submit" class="btn btn-success ml-auto" form="settingsForm">Enregistrer les changements
        </button>
      </div>
    </div>
  </div>
