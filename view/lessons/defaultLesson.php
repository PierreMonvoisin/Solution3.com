<ul id="default" class="list-group shadow">
  ...
  <li class="TopRight list-group-item list-group-item-success text-justify">
  ...
  <li class="BottomLeft list-group-item list-group-item-light text-justify">
  ...
  <li class="BottomRight list-group-item list-group-item-warning text-justify">
