<ul id="default" class="list-group shadow">
  ...
  <li class="TopLeft list-group-item list-group-item-primary text-justify main_font_color">
  ...
  <li class="TopRight list-group-item list-group-item-success text-justify main_font_color">
  ...
  <li class="BottomLeft list-group-item list-group-item-light text-justify main_font_color">
  ...
  <li class="BottomRight list-group-item list-group-item-warning text-justify main_font_color">
