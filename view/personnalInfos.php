<div id="personnalInfos" class="card mx-auto my-2 col-lg-11 col-12 px-0 bg-copper shadow">
  ...
  <div class="card-body d-lg-flex text-center px-0">
    <div class="col-lg-6 col-12 d-flex px-0">
      <ul class="list-group userInfosTitle">
      ...
      <ul class="list-group userPersonnalInfos">
        <li class="list-group-item list-group-item-action px-md-3 px-1">monvoisin.pierre@gmail.com</li>
    ...
    <div class="col-lg-6 col-12 d-flex px-0">
      ...
      <ul class="list-group userPersonnalInfos">
        <li class="list-group-item list-group-item-action px-md-3 px-1">Caillou</li>
        <li class="list-group-item list-group-item-action px-md-3 px-1">UFR2URF2B2L2F'U2R'ULDL</li>
      </ul>
    </div>
  </div>
  <div class="card-footer p-0 m-0">
    <button type="button" class="btn btn-dark btn-block">change</button>
  </div>
</div>
